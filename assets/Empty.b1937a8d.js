...
return (_ctx, _cache) => {
  return (openBlock(), createElementBlock("div", {
    ...
    createBaseVNode("span", {
      ...
      createBaseVNode("i", null, null, -1 /* HOISTED */)
    ]), 4 /* STYLE */)
...
const AutoComplete_vue_vue_type_style_index_0_scoped_28a9dc47_lang = '';
...
const data = reactive({
    values: props.values,
    searchStr: props.maxValuesCount === 1 && props.values.length === 1 ? props.values[0].name : '',
...
return (_ctx, _cache) => {
  ...
  return (openBlock(), createElementBlock("div", {
    ...
    createBaseVNode("div", { onClick: toggleFieldOpened }, [
    ...
    (data.isOpenDropdown)
              ...
              (data.isMobile)
                ? (openBlock(), createElementBlock("li", _hoisted_4, [
                    createVNode(Field, {
                      ...
                      onChange: onBoxInput
                    }, null, 8 /* PROPS */, ["icon", "placeholder", "value"])
                  ]))
                : createCommentVNode("v-if", true),
      ...
      : createCommentVNode("v-if", true),
    createBaseVNode("span", _hoisted_6, toDisplayString(props.error), 1 /* TEXT */),
            ...
            (props.maxPreviewValuesCount && data.values?.length > props.maxPreviewValuesCount)
              ? (openBlock(), createElementBlock("li", _hoisted_8, [
                  createBaseVNode("span", null, [
                    createTextVNode(toDisplayString(unref(t)('ui.autocomplete.more')) + " ", 1 /* TEXT */),
                    createBaseVNode("b", null, toDisplayString(data.values.length - props.maxPreviewValuesCount), 1 /* TEXT */)
                  ])
                ]))
              : createCommentVNode("v-if", true)
          ]))
...
const AutoComplete = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-28a9dc47"],['__file',"D:/bilbo/bilbo/shared/components/ui/AutoComplete.vue"]]);
